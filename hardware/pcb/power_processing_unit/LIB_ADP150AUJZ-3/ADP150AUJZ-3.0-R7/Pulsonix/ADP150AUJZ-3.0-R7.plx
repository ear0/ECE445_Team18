...
//3954923/1162875/2.50/5/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADP150AUJZ-3.0-R7" (originalName "ADP150AUJZ-3.0-R7")
	...
	(compDef "ADP150AUJZ-3.0-R7" (originalName "ADP150AUJZ-3.0-R7") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADP150AUJZ-3.0-R7"))
		...
		(attr "Manufacturer_Part_Number" "ADP150AUJZ-3.0-R7")
		(attr "Mouser Part Number" "584-ADP150AUJZ-3.0R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADP150AUJZ-3.0-R7?qs=WIvQP4zGangxhggizMkemw%3D%3D")
		(attr "Arrow Part Number" "ADP150AUJZ-3.0-R7")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/adp150aujz-3.0-r7/analog-devices?region=nac")
		(attr "Description" "Linear Voltage Regulators 150mA Ultra-Low Noise LDO 3.0 Vout")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/ADP150.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "ADP150AUJZ-3.0-R7.stp")
